            ...
            <div class="form-value">
                ...
                <?=form_open()?>
                    <div class="inputbox">
                        ...
                        <input type="text" value="<?=old('username')?>" name="username" id="username" class="form-control<?=$error && !empty($error_val['username']) ? ' is-invalid' : ''?>" required>
                        <label for="">Username</label>
                    </div>
                    <div class="inputbox">
                        <ion-icon name="lock-closed-outline"></ion-icon>
                        <input type="password" value="<?=old('password')?>" name="password" id="password" class="form-control<?=$error && !empty($error_val['password']) ? ' is-invalid' : ''?>" required>
                    ...
                    <button class="btn btn-primary" name="submit" value="ya">Tambah Admin</button>
                <?=form_close()?>
            </div>
        </div>
    </div>
